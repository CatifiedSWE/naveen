    ...
    <section className="relative h-screen w-full flex flex-col items-center justify-center overflow-hidden border-b border-white/5">
      ...
      <div className="relative flex flex-col items-center z-20">
        ...
        <motion.div
          ...
          className="absolute inset-0 text-[9rem] md:text-[16rem] font-cormorant leading-none text-purple-500 blur-[120px] pointer-events-none select-none text-center"
        >
          NAVEEN
        </motion.div>
        ...
        <motion.div
          ...
          className="absolute inset-0 text-[9rem] md:text-[16rem] font-cormorant leading-none text-fuchsia-400 blur-[80px] pointer-events-none select-none text-center"
        >
          NAVEEN
        </motion.div>
        ...
        <motion.div
          ...
          className="absolute inset-0 text-[9rem] md:text-[16rem] font-cormorant leading-none text-pink-300 blur-[50px] pointer-events-none select-none text-center"
        >
          NAVEEN
        </motion.div>
        ...
        <motion.div
          ...
          className="absolute inset-0 text-[9rem] md:text-[16rem] font-cormorant leading-none text-orange-200 blur-[30px] pointer-events-none select-none text-center"
        >
          NAVEEN
        </motion.div>
        ...
        <motion.div
          ...
          className="text-xs md:text-sm tracking-[1.8em] font-light uppercase text-zinc-400/90 mt-2 md:mt-4 ml-[1.8em] font-retro-mono"
          style={{ 
